...
<head>
    ...
    <title>abbasShop - Modern E-Commerce</title>
    ...
    <footer>
        <div class="container">
            ...
            <div class="footer-bottom">
                <p>&copy; 2023 abbasShop. All rights reserved.</p>
            </div>
        </div>
    </footer>
